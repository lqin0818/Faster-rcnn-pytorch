...
from utils.anchor import _enumerate_shifted_anchor, generate_anchor
...
class RegionProposalNetwork(nn.Module):
    def __init__(
        ...
        self.anchor_base = generate_anchor(anchor_scales= anchor_scales, ratios=ratios)
